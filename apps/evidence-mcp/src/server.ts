...
import type { EvidenceClient, IngestDocumentInput, ListDocumentsFilter } from './evidence-client.js';
...
/** Create and configure an evidence-mcp MCP Server backed by the given EvidenceClient. */
export function createEvidenceServer(client: EvidenceClient): Server {
