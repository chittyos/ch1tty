/**
 * JJJJJJ: explanation.outOfFocusMeanScore in ch1tty/cast when explain:true.
 *
 ...
 *
 * Covered:
 *   JJJJJJ-1: present when focus active + winner exists + out-of-focus candidates exist
 *   JJJJJJ-2: is a number >= 0 when present
 *   JJJJJJ-3: <= topOutOfFocusScore (mean is at most the top score)
 *   JJJJJJ-4: === topOutOfFocusScore when only one out-of-focus candidate
 *   JJJJJJ-5: absent on cast:no_match
 *   JJJJJJ-6: absent when no focus active
 *   JJJJJJ-7: absent when all candidates are in-focus (no out-of-focus pool)
 *   JJJJJJ-8: tool description documents outOfFocusMeanScore
 */
...
test('JJJJJJ-1: present when focus active + winner exists + out-of-focus candidates exist', async () => {
...
test('JJJJJJ-2: outOfFocusMeanScore >= 0 when present', async () => {
...
test('JJJJJJ-3: outOfFocusMeanScore <= topOutOfFocusScore', async () => {
...
test('JJJJJJ-4: outOfFocusMeanScore === topOutOfFocusScore when only one out-of-focus candidate', async () => {
...
test('JJJJJJ-5: absent on cast:no_match', async () => {
...
test('JJJJJJ-6: absent when no focus active', async () => {
...
test('JJJJJJ-7: absent when all candidates are in-focus', async () => {
...
test('JJJJJJ-8: tool description documents outOfFocusMeanScore', async () => {
