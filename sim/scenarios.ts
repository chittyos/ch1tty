...
export const SCENARIOS: Scenario[] = [
  ...
  },
  {
    ...
    note: 'near-miss: playwright/screenshot (screenshot keyword); url+browser+rendering discriminate toward get_url_screenshot',
  },
  {
    ...
    note: 'near-misses: playwright/screenshot (page keyword), browser-rendering/get_url_html_content (page keyword); click+selector uniquely scores playwright/click',
  },
  {
    id: 'design.navigate',
    focus: 'design',
    ...
    note: 'near-miss: browser-rendering/get_url_html_content (url keyword); navigate+browser uniquely matches playwright/navigate',
  },
  {
