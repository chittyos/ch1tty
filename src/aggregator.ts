...
function buildCastExplanation(
  ...
  // Scores of in-focus candidates; shared by inFocusTopScore and inFocusMeanScore.
  ...
  // Scores of out-of-focus candidates; shared by topOutOfFocusScore and outOfFocusMeanScore.
