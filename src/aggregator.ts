    ...
    return [
      ...
      },
      {
        ...
        description:
          ...
          'explanation also includes candidateScoreP95P10Ratio: number — the ratio of the 95th percentile to the 10th percentile of the candidate score distribution (candidateScoreP95 / candidateScoreP10). Present when >= 2 candidates exist and candidateScoreP10 > 0 (division guard; absent when P10 is zero, meaning >= 90% of candidates scored 0). Absent on cast:no_match, single candidate, or candidateScoreP10 === 0. Always >= 1: P95 >= P10 by monotonicity, so the ratio is at least 1; equals 1 when all candidates score identically. Spans from the 10th to the 95th percentile, an 85-percentile-point coverage — wider than the decile ratio (candidateScoreP90P10Ratio, 80pp) and narrower than candidateScoreTailAsymmetryRatio (P95/P05, 90pp). Sits strictly between candidateScoreP90P10Ratio and candidateScoreTailAsymmetryRatio by the monotonicity ordering: P90/P10 <= P95/P10 <= P95/P05. A high value signals that the top 5% of tools score far above the 10th-percentile floor — strong upper-tail concentration relative to the near-bottom. Identity: candidateScoreP95P10Ratio * candidateScoreP10 === candidateScoreP95 always holds when present. ' +
